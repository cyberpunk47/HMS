...
import { IconCalendarCheck, IconClock, IconUsers, IconX, IconCheck, IconCalendarEvent } from '@tabler/icons-react';
                                ...
                                {todaysAppointments.map((appt) => (
                                    ...
                                    >
                                        <div className="flex flex-col">
                                            <Text fw={500}>{appt.patientName}</Text>
                            ...
                            <div className="flex flex-col gap-2 max-h-[200px] overflow-y-auto">
                                {upcomingAppointments.slice(0, 5).map((appt) => (
                                    <div key={appt.id} className="flex justify-between items-center p-2 border rounded-md">
                                        <div>
                                            <Text size="sm" fw={500}>{appt.patientName}</Text>
                                            <Text size="xs" c="dimmed">{formatDateWithTime(appt.appointmentTime)}</Text>
                                        </div>
