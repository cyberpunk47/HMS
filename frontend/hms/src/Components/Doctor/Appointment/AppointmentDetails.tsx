        ...
        <div>
            ...
            <Card shadow="sm" padding="lg" radius="md" withBorder>
                <Group justify='space-between' mb={'sm'}>
                    ...
                    <Badge color={appointment.status === 'CANCELLED' ? 'red' : 'green'} variant="light">{appointment.status}</Badge>
                </Group>
                <div className='grid grid-cols- mb-2 md:grid-cols-2 gap-4'>
                ...
                {appointment.notes && <Text mt={"sm"} size='sm' color='dimmed'><strong>Notes: </strong>{appointment.notes}</Text>}
